...
class SecurityPerformanceOptimizer:
    ...
    def _cache_encryption_keys(self) -> None:
        ...
        try:
            ...
            # Cache master keys with expiration
            master_keys = encryption_manager.get_master_keys()
            for key_id, key_data in master_keys.items():
            ...
            self.logger.info(f"Cached {len(master_keys)} encryption keys")
